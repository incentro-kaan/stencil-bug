...
const NAMESPACE = 'stencilbug';
const BUILD = /* stencilbug */ { allRenderFn: false, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: true, propNumber: false, propString: true, reflect: false, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: false, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: false, vdomFunctional: false, vdomKey: false, vdomListener: false, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: true };
...
class PnlWebComponent {
  ...
  static get watchers() { return {
    "contentString": ["dataDidChangeHandler"]
  }; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "pnl-web-component",
    "$members$": {
      "contentString": [1, "content-string"],
      "contentSrc": [1, "content-src"],
      "content": [1032]
    },
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
...
const wcChildCss = "/*!@:host*/.sc-wc-child-h{display:block}";
...
class WcChild {
  ...
  render() {
    return (hAsync(Host, null, this.introTitle &&
      hAsync("h2", null, this.introTitle), hAsync("slot", null)));
  }
  static get style() { return wcChildCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "wc-child",
    "$members$": {
...
const wcParentCss = "/*!@:host*/.sc-wc-parent-h{display:block}";
...
class WcParent {
  ...
  render() {
    return (hAsync(Host, null, hAsync("wc-child", { "intro-title": this.content.introtitle }), hAsync("slot", null)));
  }
  static get style() { return wcParentCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "wc-parent",
    "$members$": {
...
__decorate([
  dist.use(PnlWebComponent)
], WcParent.prototype, "this", void 0);
